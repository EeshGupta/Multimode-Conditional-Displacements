...
class ecd_pulse_two_mode: 
    ...
    def plot_pulses(self): 
        ...
        axs[0].set_ylabel('Mode 1 Drive (Ghz)', fontsize = 10)
        #axs[1].plot(np.real(self.alpha1))
        #axs[1].plot(np.imag(self.alpha1))
        #axs[1].set_ylabel('alpha 1', fontsize = 10)

        axs[1].plot(np.real(self.cavity2_dac_pulse_GHz))
        axs[1].plot(np.imag(self.cavity2_dac_pulse_GHz))
        axs[1].set_ylabel('Mode 2 Drive (Ghz)', fontsize = 10)
